...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<Long, String, String, Boolean, LocalDateTime> {

    private static final long serialVersionUID = 927347725;
     ...
     */
    @Override
    public UserRecord values(Long value1, String value2, String value3, Boolean value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Long id, String name, String password, Boolean sex, LocalDateTime created) {
        super(User.USER);
